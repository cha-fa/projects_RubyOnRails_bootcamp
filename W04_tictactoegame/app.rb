...
#initiatisation du jeu
my_app = Application.new

#welcome
my_app.welcome_message
#methode qui demande le nom + symbole aux joueurs 
my_app.game_start 

#lancement du jeu jusqu'à ce que les cases soientcomplète ou que quelqu'un gagne
my_app.game_itself
